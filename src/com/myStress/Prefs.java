...
/**
 * Handles preferences (general and handler-specific ones) for myStress
 * @see myStress_settings_tab
 */
public class Prefs extends PreferenceActivity 
{
    ...
    public void onCreate(Bundle savedInstanceState) 
    {
        ...
        if (myStress_settings_tab.current_handler != null)
        	myStress_settings_tab.current_handler.configurePreference(this);
    }
    ...
    public void onDestroy() 
    {
        ...
        if (myStress_settings_tab.current_handler != null)
        	myStress_settings_tab.current_handler.destroy();
    }
