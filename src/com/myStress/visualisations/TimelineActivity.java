...
import com.myStress.myStress_local;
...
{   
    ...
    public void onCreate(Bundle savedInstanceState) 
    {
            ...
            Symbol = bundle.getString("com.myStress.Symbol");		// get symbol
            ...
            if (myStress_storage != null)
            {
		        ...
		        title = bundle.getString("com.myStress.Title");
		        if (title != null)
    ...
    public boolean onOptionsItemSelected(MenuItem item) 
    {
        ...
        case R.id.main_about:
    		...
    		builder.setTitle(getString(R.string.myStress_Timeline))
	...
	private class GatherTask extends AsyncTask<String, Long, Long> 
	{
	     protected Long doInBackground(String... params) 
	     {
				...
				if (values == null)
				{
					...
					query = new String("SELECT Timestamp, Value from 'myStress_values' WHERE Timestamp BETWEEN " + String.valueOf(startedTime) + " AND " + String.valueOf(endTime) + " AND Symbol='" + Symbol + "'");
	     ...
	     protected void onPostExecute(Long result) 
	     {
	    	 ...
	    	 {
	             Log.e("myStress", "...terminated GatherThread()");
