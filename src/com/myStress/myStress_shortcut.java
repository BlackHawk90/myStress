...
import com.myStress.database.myStress_restore;
 ...
 */
public class myStress_shortcut extends Activity
{
     // preferences
	 ...
	 @Override
	    public void onCreate(Bundle savedInstanceState) 
	    {
			...
			if (settings.getBoolean("myStress_local::running", false) == true)
			{
	    		...
	    		builder.setMessage(R.string.myStress_running_exit2)
	    			   .setTitle(R.string.myStress_Local_Sensing)
	    		       .setCancelable(false)
	 ...
	 public void onActivityResult(int requestCode, int resultCode, Intent data) 
	    ...
	    private ServiceConnection mConnection = new ServiceConnection() 
	    {
	  	    public void onServiceConnected(ComponentName className, IBinder service) 
	  	    {
        		...
        		myStress_locally.template = new String(template);
        		
    		    // announce and finish
    		    if (myStress_locally.running == true)
