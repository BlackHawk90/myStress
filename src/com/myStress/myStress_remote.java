...
import com.myStress.platform.Acquisition;
import com.myStress.platform.Discovery;
import com.myStress.platform.EventComponent;
 ...
 */
public class myStress_remote extends Service
{
   ...
   /**
    ...
    {
    	myStress_remote getService() 
        {
            return myStress_remote.this;
        }
    }
	...
	{		
		...
		this.myStress = this.getApplicationContext();
		...
		notification = new Notification(R.drawable.notification_icon, "Starting myStress", System.currentTimeMillis());

		// create pending intent for starting the activity
		contentIntent = PendingIntent.getActivity(this, 0, new Intent(this, myStress_remotevalues.class),  Intent.FLAG_ACTIVITY_NEW_TASK);
		notification.setLatestEventInfo(getApplicationContext(), "myStress Remote Sensing", "...is trying to connect since...", contentIntent);
		...
		if (instEC.startEC(this, IPAddress, IPPort) == true)
		{
			 ...
			 // create pending intent for starting the activity
			 contentIntent = PendingIntent.getActivity(this, 0, new Intent(this, myStress_remotevalues.class),  Intent.FLAG_ACTIVITY_NEW_TASK);
			 notification.setLatestEventInfo(getApplicationContext(), getString(R.string.myStress_Remote_Sensing), getString(R.string.running_since), contentIntent);
			 notification.flags = Notification.FLAG_NO_CLEAR;
			 ...
			 wl = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "myStress Remote Lock");
			 wl.acquire();
	...
	public final Handler mHandler = new Handler() 
    {
       ...
       public void handleMessage(Message msg) 
       {
           ...
           case BATTERY_KILL:
  			...
  			notification.setLatestEventInfo(getApplicationContext(), getString(R.string.myStress_Remote_Sensing), getString(R.string.killed_at) + " " + Integer.toString(BatteryKill_i) + "% " + getString(R.string.battery) + "...", contentIntent);
