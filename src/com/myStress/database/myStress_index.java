...
/**
 * Class to index the myStress database
 *
 * @see         myStress_database
 */
public class myStress_index extends Activity
{
	// states for handler 
    ...
    public void onCreate(Bundle savedInstanceState) 
    {
        ...
        myStress = getApplicationContext();
		...
		public void run()
	     {
	    	 ...
	    	 try 
	    	 {
    		    ...
    		    {	            
    	            // get database
    	            database_helper = new myStress_database(myStress);
    	            do
    	            {
    		    ...
    		    catch(Exception e)
    		    {
     	    	...
     	    	String command = "CREATE INDEX 'time_index' ON 'myStress_values' ('timestamp' ASC)";	        	
    	    	myStress_storage.execSQL(command);
