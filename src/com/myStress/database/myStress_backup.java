...
/**
 * Activity to backup the myStress database
 *
 * @see myStress_restore
 */
public class myStress_backup extends Activity
{
    ...
    public void onCreate(Bundle savedInstanceState) 
    {
        ...
        // setup resources
		// check if persistent flag is running, indicating the myStress has been running
    ...
    /** Thread for backing up the myStress database outside the main UI thread. 
     */
	     ...
	     */
	     public void run()
	     {
	    	 ...
	    	 try 
	    	 {
	    	        ...
	    	        if (sd.canWrite()) 
	    	        {
	    	            String backupDBPath = "myStress_backup.db";
	    	            File currentDB = getDatabasePath(myStress_database.DATABASE_NAME);
