 ...
 * @see Handler
 */
public class MusicPlayerHandler implements com.myStress.handlers.Handler
{
	...
	{
    	SensorRepository.insertSensor(new String("MP"), new String("Music"), myStress.getString(R.string.MP_d), myStress.getString(R.string.MP_e), new String("txt"), 0, 0, 1, false, 0, this);	    	    	
    	SensorRepository.insertSensor(new String("MA"), new String("Artist"), myStress.getString(R.string.MA_d), myStress.getString(R.string.MA_e), new String("txt"), 0, 0, 1, false, 0, this);	    	    	
    	SensorRepository.insertSensor(new String("ML"), new String("Album"), myStress.getString(R.string.ML_d), myStress.getString(R.string.ML_e), new String("txt"), 0, 0, 1, false, 0, this);	    	    	
    	SensorRepository.insertSensor(new String("MT"), new String("Track"), myStress.getString(R.string.MT_d), myStress.getString(R.string.MT_e), new String("txt"), 0, 0, 1, false, 0, this);	    	    	
	}
	 ...
	 */
	public MusicPlayerHandler(Context myStress)
	{
