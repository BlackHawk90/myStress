...
/**
 * Widget provider for the event annotation widget
 * 
 * @see android.appwidget.AppWidgetProvider
 */
public class EventButton_widget extends AppWidgetProvider {
	/**
	 * Called when widget is updated, including when it is created the first
	 * time Here, we hook the pressing of the widget to the UI thread, having
	 * the UI send a broadcast to the EventButtonHandler if it pressed
	 * 
	...
	public void onUpdate(Context context, AppWidgetManager appWidgetManager,
		...
		// create our own broadcast event for event button pressing ->
		// EventButtonHandler subscribes to this!
		Intent defineIntent = new Intent("com.myStress.eventbutton");
