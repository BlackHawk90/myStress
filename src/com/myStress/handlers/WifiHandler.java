...
public class WifiHandler extends PhoneStateListener implements com.myStress.handlers.Handler, Runnable
{
	 ...
	 * As the result of the discovery, appropriate {@link com.myStress.platform.Sensor} entries will be added to the {@link com.myStress.platform.SensorRepository}, if WiFi available
	...
	public void Discover()
	{
	    ...
	    {		
			...
			SensorRepository.insertSensor(new String("WC"), new String("on/off"), myStress.getString(R.string.WC_d), myStress.getString(R.string.WC_e), new String("int"), 0, 0, 1, false, 0, this);
		}	    
	}
