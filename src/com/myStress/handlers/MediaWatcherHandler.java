...
public class MediaWatcherHandler implements Handler
{
	 ...
	 * As the result of the discovery, appropriate {@link com.myStress.platform.Sensor} entries will be added to the {@link com.myStress.platform.SensorRepository}, if any watching is selected by the user in the configuration
	...
	public void Discover()
	{
		...
		if (camera == true || music == true || pictures == true || videos == true)
			SensorRepository.insertSensor(new String("MW"), new String("file"), myStress.getString(R.string.MW_d), myStress.getString(R.string.MW_e), new String("txt"), 0, 0, 1, false, 0, this);	    
	}
	 ...
	 */
	public MediaWatcherHandler(Context myStress)
	{
