...
//	    SensorRepository.insertSensor(new String("TL"), new String("chars"), myStress.getString(R.string.TL_d), myStress.getString(R.string.TL_e), new String("int"), 0, 0, 100000, false, 0, this);
	    SensorRepository.insertSensor(new String("TS"), new String("chars/min"), myStress.getString(R.string.TS_d), myStress.getString(R.string.TS_e), new String("int"), 0, 0, 20, false, 0, this);
	}
	 ...
	 */
	public TypingSpeedHandler(Context myStress)
	{
