 ...
 * @see Handler
 */
public class EventTextHandler implements com.myStress.handlers.Handler
{
	...
	public byte[] Acquire(String sensor, String query)
	{
		...
		if(sensor.compareTo("ET") == 0)
		{
			...
			if (registered == false)
			{
				...
				IntentFilter intentFilter = new IntentFilter("com.myStress.eventtext");
	...
	{
		SensorRepository.insertSensor(new String("ET"), new String("Event"), myStress.getString(R.string.ET_d), myStress.getString(R.string.ET_e), new String("str"), 0, 0, 1, false, 0, this);	    
	}
	 ...
	 */
	public EventTextHandler(Context myStress)
	{
	...
	private final Handler mHandler = new Handler() 
    {
       ...
       {       
           ...
           {
           case SHOW_TOAST:
        	   Toast.makeText(myStress.getApplicationContext(), myStress.getString(R.string.Recorded_shared_text), Toast.LENGTH_LONG).show();     
        	   break;
           }
       }
    };
	...
	private final BroadcastReceiver SystemReceiver = new BroadcastReceiver() 
	{
        ...
        public void onReceive(Context context, Intent intent) 
        {
            ...
            if (action.equals("com.myStress.eventtext")) 
            {
