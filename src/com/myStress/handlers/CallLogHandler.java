...
public class CallLogHandler implements Handler
{
	...
	{
	    SensorRepository.insertSensor(new String("PH"), myStress.getString(R.string.PH_u), myStress.getString(R.string.PH_d), myStress.getString(R.string.PH_e), new String("txt"), 0, 0, 65535, false, polltime, this);
	}
