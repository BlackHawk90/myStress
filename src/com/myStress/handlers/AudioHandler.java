...
public class AudioHandler implements Handler
{
	...
	public void History(String sensor)
	{
		...
		{
			case 'S' :
				History.timelineView(myStress, "Sound Pressure Level [dB]", "AS");
				break;
			default:
				History.timelineView(myStress, "Frequency [Hz]", "AF");
				break;
		}
	}
	...
	public void Discover()
	{
		...
		SensorRepository.insertSensor(new String("AF"), new String("Hz"), myStress.getString(R.string.AF_d), myStress.getString(R.string.AF_e), new String("int"), 0, 0, 15000, true, polltime, this);
		SensorRepository.insertSensor(new String("AS"), new String("dB"), myStress.getString(R.string.AS_d), myStress.getString(R.string.AS_e), new String("int"), -2, 0, 1200, true, polltime, this);
	}
	 ...
	 */
	public AudioHandler(Context myStress)
	{
