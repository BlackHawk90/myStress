...
public class EventButtonHandler implements Handler
{
	...
	public byte[] Acquire(String sensor, String query)
	{
		...
		if(sensor.compareTo("EB") == 0)
		{
			...
			if (registered == false)
			{
				...
				IntentFilter intentFilter = new IntentFilter("com.myStress.eventbutton");
		        nors.registerReceiver(SystemReceiver, intentFilter);
		        intentFilter = new IntentFilter("com.myStress.eventselected");
		        nors.registerReceiver(SystemReceiver, intentFilter);
		        registered = true;
			}
	...
	private final BroadcastReceiver SystemReceiver = new BroadcastReceiver() 
	{
        ...
        public void onReceive(Context context, Intent intent) 
        {
            ...
            if (action.equals("com.myStress.eventbutton")) 
            {
    			try
    			{
            ...
            if (action.equals("com.myStress.eventselected")) 
            {
