...
//	private static final int HMX_STRIDE		= 51;
	 ...
	 */
	public HeartMonitorHandler(Context myStress)
	{
		// save for later
	...
	public void History(String sensor)
	{
		...
		{
		case 'P':
			History.timelineView(myStress, "Heart rate [bpm]", "HP");
			break;
		case 'I':
			History.timelineView(myStress, "Instant Speed [m/s]", "HI");
			break;
		}		
	}
	 ...
	 * As the result of the discovery, appropriate {@link com.myStress.platform.Sensor} entries will be added to the {@link com.myStress.platform.SensorRepository}, if the monitor is selected by the user to be used
	...
	public void Discover()
	{
		if (use_monitor == true)
		{
			SensorRepository.insertSensor(new String("HL"), new String("%"), myStress.getString(R.string.HL_d), myStress.getString(R.string.HL_e), new String("int"), 0, 0, 100, true, 10000, this);
			SensorRepository.insertSensor(new String("HP"), new String("bpm"), myStress.getString(R.string.HP_d), myStress.getString(R.string.HP_e), new String("int"), 0, 0, 200, true, 1000, this);
			SensorRepository.insertSensor(new String("HI"), new String("m/s"), myStress.getString(R.string.HI_d), myStress.getString(R.string.HI_e), new String("int"), -1, 0, 200, true, 1000, this);
		}
	}
