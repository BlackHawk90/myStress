	  ...
	  */
	   @Override
	    ...
	    {	    
	        ...
	        mTitle.setText(getString(R.string.myStress_BloodPressure));
	    ...
	    */
	     ...
	     * Here, we obtain the self-annotated text and send a broadcast to the {@link com.myStress.handlers.BloodPressureButtonHandler}
	    ...
	    {	    	
	    	...
	    	if (selected == true)
	    	{
				...
				Intent intent = new Intent("com.myStress.bloodpressure");
