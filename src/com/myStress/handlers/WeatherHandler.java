...
public class WeatherHandler implements com.myStress.handlers.Handler, Runnable
{
	...
	public void Discover()
	{
		if (weather_enabled == true)
		{
			...
			SensorRepository.insertSensor(new String("VI"), myStress.getString(R.string.VI_u), myStress.getString(R.string.VI_d), myStress.getString(R.string.VI_e), new String("str"), 0, 0, 1, true, 0, this);	    
		}
	}
