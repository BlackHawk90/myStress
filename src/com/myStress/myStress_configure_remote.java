...
import com.myStress.helper.SafeCopyPreferences;

/**
 * Activity to remotely configure myStress. The parameters for the configuration are sent through
 * an Android Intent with the paramters
 * @param com.myStress.template.name name of the template shortcut to be created
 * @param com.myStress.template.text text of the template file to be created and used in the shortcut
 */
public class myStress_configure_remote extends Activity
{
     // template to be set
	 private String template, template_text;
	   ...
	   @Override
	    public void onCreate(Bundle savedInstanceState) 
	    {
	        ...
	        template = bundle.getString("com.myStress.template.name");
	        template_text = bundle.getString("com.myStress.template.text");
			...
			if (external_storage != null)
			{
                ...
                {
                	Log.e("myStress", "Cannot write template text into file!");
                	finish();
                }
	            ...
	            // intent for starting myStress
	    	    Intent intent;
	        	Intent shortcutIntent = new Intent(Intent.ACTION_MAIN); 
	        	shortcutIntent.setClassName(getApplicationContext(), myStress_shortcut.class.getName()); 
	        	...
	        	sendBroadcast(intent);    
	           	...
	           	Toast.makeText(getApplicationContext(), getString(R.string.Configured_myStress), Toast.LENGTH_LONG).show();          
			}
