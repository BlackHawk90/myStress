...
public class TCPClient
{
	...
	private myStress_remote myStress;
	 ...
	 * @param myStress Reference to the {@link myStress_remote} service calling this TCP client
	 ...
	 */
	public boolean startTCP(myStress_remote myStress, String IPAddress, String IPPort)
	{
		TelephonyManager tm;
		...
		try
		{
			tm  = (TelephonyManager) myStress.getSystemService(Context.TELEPHONY_SERVICE);
			IMEI = tm.getDeviceId();
		}
		catch(Exception e)
		{
