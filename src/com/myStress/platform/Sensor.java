...
public class Sensor 
{
	...
	/**
	 * Sensor is invalid, e.g., when BT pulse cannot be found when myStress is started
	 */
    ...
    /**
     * time when sensor was saved in myStress_sensor_used for cases where sensors are removed by Storica
     */
