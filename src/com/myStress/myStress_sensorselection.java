 ...
 * @see myStress_local
 */
public class myStress_sensorselection extends Activity
{
    // handler for starting local myStress
	private static final int DISCOVER_LOCALLY = 2;
	
	private Activity myStress;
    ...
    public void onDestroy() 
    {
       ...
       {
    	   myStress_locally.saveSelections();
    ...
    {    	
        ...
        case R.id.local_selectall:
       		myStress_locally.selectall();
        	return true;
        case R.id.local_unselectall:
       		myStress_locally.unselectall();
       		return true;
        case R.id.local_sensorinfo:
        	myStress_locally.sensor_info();
        	return true;        	
        }
        return true;
    }    
	...
	private final Handler mHandler = new Handler() 
    {
       ...
       public void handleMessage(Message msg) 
       {
           ...
           case DISCOVER_LOCALLY:
       		   myStress_locally.Discover(myStress);
    ...
    private ServiceConnection mConnection = new ServiceConnection() 
    {
  	    public void onServiceConnected(ComponentName className, IBinder service) 
  	    {
			...
			if (myStress_locally != null)
			{
		    	progressdialog = ProgressDialog.show(myStress, getString(R.string.Gathering_sensors), getString(R.string.Please_wait), true);
